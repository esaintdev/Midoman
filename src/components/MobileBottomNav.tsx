      ...
      <div className="flex justify-around items-center">
        ...
        >
          <div className={`w-6 h-6 mb-1 ${
            isActiveRoute("/") ? "text-[#076DF2]" : (darkMode ? "text-gray-400" : "text-gray-400")
          }`}>
        ...
        >
          <div className={`w-6 h-6 mb-1 ${
            isActiveRoute("/escrow") ? "text-[#076DF2]" : (darkMode ? "text-gray-400" : "text-gray-400")
          }`}>
        ...
        >
          <div className="w-12 h-12 flex items-center justify-center mb-1 shadow-lg hover:shadow-xl transition-shadow" style={{ backgroundColor: '#076DF2', borderRadius: '50%' }}>
        ...
        >
          <div className={`w-6 h-6 mb-1 ${
            isActiveRoute("/transaction") ? "text-[#076DF2]" : (darkMode ? "text-gray-400" : "text-gray-400")
          }`}>
        ...
        >
          <div className={`w-6 h-6 mb-1 ${
            isActiveRoute("/settings") ? "text-[#076DF2]" : (darkMode ? "text-gray-400" : "text-gray-400")
          }`}>
