    ...
    <main className="flex-1 p-4 md:p-8">
      <div className="flex items-center justify-between mb-6 md:mb-8">
        <div className="flex items-center justify-between w-full lg:w-auto">
          <h2 className="text-2xl md:text-3xl font-bold font-sans text-gray-800">Settings</h2>
          <button
            onClick={onMenuClick}
      ...
      <div className={`${darkMode ? "bg-gray-800" : "bg-white"} rounded-2xl p-8 text-center`}>
        <h3 className="text-xl font-semibold text-gray-800 mb-4">Application Settings</h3>
